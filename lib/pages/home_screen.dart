...
import 'package:watchstone/components/expanded_section.dart';
import 'package:watchstone/data/expanded_data.dart';
import 'package:watchstone/data/info_data.dart';
import 'package:watchstone/data/watch_data.dart';
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Container(alignment: Alignment.centerLeft, width: 35, child: Image.asset(info[i].imageUrl)),
                                  Text(
                                   info[i].title,
                                    style: TextStyle(fontWeight: FontWeight.w600),
                                  ),
                                  SizedBox(width: 7),
                                  Text(info[i].subTitle)
                                ],
                              ),
                            ),
                            SizedBox(height: 10)
                          ...
                          children: <Widget>[
                            for (int i = 0; i < expandedData.length; i++)
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                   expandedData[i].title,
                                    style: TextStyle(fontWeight: FontWeight.w600),
                                  ),
                                  SizedBox(height: 10),
                                  Text(expandedData[i].subtitle),
                                  SizedBox(height: 20),
                                ],
                              )
                          ],
